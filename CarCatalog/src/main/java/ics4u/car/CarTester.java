...
//Note: Access my API key at https://azure.microsoft.com/en-us/try/cognitive-services/my-apis/

public class CarTester extends Application
{
	//***** CLASS VARIABLES *****
    ...
    private class Car 
    {
    	//variables for car properties
    	//I will pass make and model as a single string for the search query (ex: Honda Civic)
        ...
        //Constructor that sets the year, make, and model
    ...
    private final TableView<Car> tableView = new TableView<>(); 				       //The table to hold the CSV data
    private final ObservableList<Car> dataList = FXCollections.observableArrayList(); //The list that will be referenced when adding data
    private Car car;
	...
	{	
		...
		//function to add the components to the first tab
		//Main menu
		createMainMenu(tA);
		
		//Second and third tabs, the second will contain the table
		//The third tab will display the picture
		Tab tB = new Tab("Select a car");
		Tab tC = new Tab("Purchase");
 
		//Root node that will hold the table and the button
        ...
        /*
        Potential fourth column for type of car, for some odd reason this is formatted weirdly in the CSV
        ...
        */
        ...
        status.setStyle("    -fx-font-size: 11pt;\n" + 
        ...
        get.setStyle("    -fx-font-size: 11pt;\n" + 
        		"    -fx-font-family: \"Helvetica\";");
