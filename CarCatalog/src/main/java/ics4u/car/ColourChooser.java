...
//I got this class from GitHub https://gist.github.com/jewelsea/2030464
...
class ColorChooser extends VBox {
	  ...
	  private static final String[][] webPalette = {
	    ...
	    {"plum", "#dda0dd"},{"powderblue", "#b0e0e6"},{"purple", "#800080"},{"RED", "#dc143c"},
	  ...
	  public ColorChooser(String[][] colors) {
	    ...
	    for (String[] namedColor : colors) {
	      ...
	      colorChoice.setOnMouseEntered(new EventHandler<MouseEvent>() {
	        @Override public void handle(MouseEvent mouseEvent) {
	          final String borderStyle = "-fx-border-color: ladder(" + colorHex + ", whitesmoke 49%, white 50%); -fx-border-width: 2;";
	    ...
	    setStyle("-fx-background-color: white; -fx-text-fill: white; -fx-font-size: 16; -fx-font-family: \"Helvetica\";");
